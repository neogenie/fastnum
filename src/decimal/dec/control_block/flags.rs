...
impl ControlBlock {
    ...
    pub const NAN: Self = Self(Self::NAN_MASK);
    pub const SIGNALING_NAN: Self = Self(Self::SIGNALING_NAN_MASK);
    pub const INFINITY: Self = Self(Self::MIN_SCALE | Self::INFINITY_MASK);
    pub const NEG_INFINITY: Self = Self(Self::MIN_SCALE | Self::NEG_INFINITY_MASK);
    ...
    #[inline(always)]
    pub(crate) const fn set_sign(&mut self, sign: Sign) {
