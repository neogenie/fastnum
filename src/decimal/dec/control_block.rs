...
impl ControlBlock {
    const MIN_SCALE: u64 = 0x0000_0000_0001_8000;
    const MAX_SCALE: u64 = 0x0000_0000_0001_7FFF;

    const SCALE_MASK: u64 = 0x0000_0000_0000_FFFF;

    #[inline(always)]
    pub const fn default() -> Self {
        Self::new(0, Sign::Plus)
    }

    #[inline(always)]
    pub const fn new(scale: i16, sign: Sign) -> Self {
    ...
    pub const fn get_exponent(&self) -> i32 {
        ((self.0 & Self::SCALE_MASK) as i32).overflowing_neg().0
    }
