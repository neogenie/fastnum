...
/// Serialize/deserialize [crate::decimal::Decimal] as arbitrary precision numbers in JSON using
...
/// Serialize/deserialize optional [crate::decimal::Decimal] as arbitrary precision numbers in
